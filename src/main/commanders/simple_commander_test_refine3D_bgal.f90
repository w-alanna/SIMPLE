module simple_commander_test_bgal_refine3D
    ...
    subroutine exec_test_bgal_refine3D(self, cline)
        ...
        ! commands debug
            ...
            ! print *, ' -------- '
            ! call import_particles_cline%printline()
            ! print *, ' -------- '
            ! call cluster2D_cline%printline()
            ! print *, ' -------- '
            ! call map_cavgs_selection_cline%printline()
            ! print *, ' -------- '
            ! call initial_3Dmodel_cline%printline()
            ! print *, ' -------- '
            ! call refine3D_cline%printline()
            ! print *, ' -------- '
            ! call automask_cline%printline()
            ! print *, ' -------- '
            ! call refine3D_two_cline%printline()
            ! print *, ' -------- '
